...
"""
IN: for all operations, when it's doable, enqueue them into the corresponding machine_q
OUT: Once the agent act, a dispatching rule is selected to determine which operation in the machine_q 
